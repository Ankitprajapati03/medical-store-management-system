...
class DeleteCompany implements KeyListener,ActionListener
{
JFrame f;
JLabel l1,l2,l3;
JTextField t1,t2;
...
DeleteCompany()
{
f=new JFrame("Delete Company Details");
f.setSize(530,480);
...
try
{
st=con.prepareStatement("delete from company where company_id=?");
st.setString(1,id);
st.executeUpdate();
JOptionPane.showMessageDialog(f,"Successfully Delete Company Details");
t1.setText("");
t2.setText("");
t3.setText("");
t1.requestFocus();
