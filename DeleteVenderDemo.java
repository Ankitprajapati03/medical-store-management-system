...
class DeleteVender implements ActionListener,KeyListener
{
JFrame f;
...
try
{
st=con.prepareStatement("delete from vendor where vendor_id=?");
st.setString(1,id);
st.executeUpdate();
JOptionPane.showMessageDialog(f,"Successfully Delete Vendor Details");
t1.setText("");
t2.setText("");
t3.setText("");
t4.setText("");
...
class DeleteVenderDemo
{
public static void main(String[] s)
{
DeleteVender dl=new DeleteVender();
}
}