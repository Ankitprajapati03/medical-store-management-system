//design a screen for Deletecustomer
import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
import java.sql.*;

class DeleteCustomer implements ActionListener,KeyListener
{
JFrame f;
JLabel l1,l2,l3,l4;
...
try
{
st=con.prepareStatement("delete from customer where cs_id=?");
st.setString(1,id);
st.executeUpdate();
